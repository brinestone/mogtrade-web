 ...
 */
export function checkEmailAvailableResource(params: Signal<CheckEmailAvailableParams>,
  options: OrvalHttpResourceOptions<CheckEmailAvailableResponseContentOutput, unknown, true> & { defaultValue: NoInfer<CheckEmailAvailableResponseContentOutput> }): HttpResourceRef<CheckEmailAvailableResponseContentOutput>;
export function checkEmailAvailableResource(params: Signal<CheckEmailAvailableParams>,
  options?: OrvalHttpResourceOptions<CheckEmailAvailableResponseContentOutput, unknown, true>): HttpResourceRef<CheckEmailAvailableResponseContentOutput | undefined>;
export function checkEmailAvailableResource(params: Signal<CheckEmailAvailableParams>,
  options?: OrvalHttpResourceOptions<CheckEmailAvailableResponseContentOutput, unknown, true>): HttpResourceRef<CheckEmailAvailableResponseContentOutput | undefined> {
  return httpResource<CheckEmailAvailableResponseContentOutput>(() => {

    const request = ({
      url: `/api/v1/auth/email-available`,
      params: filterParams(params?.() ?? {}, new Set<string>([]))
    });
    return applyOrvalRequestExtension(request, options);
  }, {
    ...(options ?? {}),
    parse: CheckEmailAvailableResponseContent.parse
  });
}
 ...
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function rotateAccessTokenResource(options: OrvalHttpResourceOptions<RotateAccessTokenResponseContentOutput, unknown, true> & { defaultValue: NoInfer<RotateAccessTokenResponseContentOutput> }): HttpResourceRef<RotateAccessTokenResponseContentOutput>;
export function rotateAccessTokenResource(options?: OrvalHttpResourceOptions<RotateAccessTokenResponseContentOutput, unknown, true>): HttpResourceRef<RotateAccessTokenResponseContentOutput | undefined>;
export function rotateAccessTokenResource(options?: OrvalHttpResourceOptions<RotateAccessTokenResponseContentOutput, unknown, true>): HttpResourceRef<RotateAccessTokenResponseContentOutput | undefined> {
  return httpResource<RotateAccessTokenResponseContentOutput>(() => applyOrvalRequestExtension(`/api/v1/auth/refresh`, options), {
    ...(options ?? {}),
    parse: RotateAccessTokenResponseContent.parse
  });
}

export type CheckEmailAvailableResourceResult = NonNullable<CheckEmailAvailableResponseContentOutput>
export type RotateAccessTokenResourceResult = NonNullable<RotateAccessTokenResponseContentOutput>
