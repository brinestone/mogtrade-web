 ...
 */
export function getWalletInfoResource(type: Signal<WalletType>,
  options: OrvalHttpResourceOptions<GetWalletInfoResponseContentOutput, unknown, true> & { defaultValue: NoInfer<GetWalletInfoResponseContentOutput> }): HttpResourceRef<GetWalletInfoResponseContentOutput>;
export function getWalletInfoResource(type: Signal<WalletType>,
  options?: OrvalHttpResourceOptions<GetWalletInfoResponseContentOutput, unknown, true>): HttpResourceRef<GetWalletInfoResponseContentOutput | undefined>;
export function getWalletInfoResource(type: Signal<WalletType>,
  options?: OrvalHttpResourceOptions<GetWalletInfoResponseContentOutput, unknown, true>): HttpResourceRef<GetWalletInfoResponseContentOutput | undefined> {
  return httpResource<GetWalletInfoResponseContentOutput>(() => applyOrvalRequestExtension(`/api/v1/wallet/${type()}`, options), {
    ...(options ?? {}),
    parse: GetWalletInfoResponseContent.parse
  });
}

export type GetWalletInfoResourceResult = NonNullable<GetWalletInfoResponseContentOutput>
